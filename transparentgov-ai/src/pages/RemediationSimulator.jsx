...
export default function RemediationSimulator() {
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
            <h2 className="text-4xl font-extrabold text-gray-800 mb-4">Interactive Code Remediation</h2>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md space-y-4 mb-8">
                <div>
                    <label htmlFor="vulnerable-code" className="block text-sm font-medium text-gray-700 mb-1">
                        1. Paste Vulnerable Code Snippet
                    </label>
                    <textarea
                        id="vulnerable-code"
                        className="w-full h-64 p-3 border rounded-md focus:ring-2 focus:ring-blue-500 font-mono text-sm"
                ...
                <div>
                    <label htmlFor="vulnerability-description" className="block text-sm font-medium text-gray-700 mb-1">
                        2. Describe the Vulnerability
                    </label>
                    <textarea
                        id="vulnerability-description"
                        className="w-full h-24 p-3 border rounded-md focus:ring-2 focus:ring-blue-500"
                ...
                <button
                    ...
                    className="w-full flex justify-center items-center gap-2 px-6 py-3 bg-purple-600 text-white font-bold rounded-md hover:bg-purple-700 disabled:bg-gray-400 transition-colors"
                >
